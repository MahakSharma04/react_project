      ...
      <div className="container">
            ...
            <div className="footer-logo">
              ...
              <ul className="list-group">
                <li className="list-group-item d-flex align-items-center">
                  ...
                  <span className="ms-3">
                    +78Wh4 NIT Rourkela <br /> Odisha, India, pincode 33311
                  </span>
                </li>
                <li className="list-group-item d-flex align-items-center">
                  <div className="icon-background">
                  ...
                  <span className="ms-3">
                    ramesh456@gmail.com <br /> tulsi67@gmail.com
                  </span>
                </li>
                <li className="list-group-item d-flex align-items-center">
                  <div className="icon-background">
                  ...
                  <span className="ms-3">
                    +91 8423 5463 12 <br /> +91 2627 8729 78
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="copyright">© 2024 RestrO. All Rights Reserved.</div>
          </div>
        </div>
      </div>
    </div>
